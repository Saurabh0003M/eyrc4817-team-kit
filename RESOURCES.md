...
same way as the portal. **Module** tells you where it fits in [`LEARNING-ROADMAP.pdf`](LEARNING-ROADMAP.pdf).
...
[8 MQTT (PacBot)](#8-mqtt-pacbot) · [9 Path planning](#9-path-planning) · [10 Extras added by the roadmap](#10-extras-added-by-the-roadmap)
...
| 🔒 KD learnings: [Linux](https://portal.e-yantra.org/courses/theme_kd/learnings/linux/linux/) · [ROS 2](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/ros/) · [ROS 2 Concepts](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/ros2_concepts/) · [ROS 2 Tutorials](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/ros2_tutorials/) · [Turtlesim](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/turtlesim_tutorials/) · [ROS 2 Books](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/ros_books/) · [MuJoCo](https://portal.e-yantra.org/courses/theme_kd/learnings/mujoco/mujoco/) · [MuJoCo Concepts](https://portal.e-yantra.org/courses/theme_kd/learnings/mujoco/mujoco_concepts/) · [MuJoCo Tutorials](https://portal.e-yantra.org/courses/theme_kd/learnings/mujoco/mujoco_tutorials/) · [Quadcopters](https://portal.e-yantra.org/courses/theme_kd/learnings/quadcopter/quadcopters/) · [Swift Pico model](https://portal.e-yantra.org/courses/theme_kd/learnings/quadcopter/swift_model/) · [Control Systems](https://portal.e-yantra.org/courses/theme_kd/learnings/control_system/control_systems/) · [System Modelling](https://portal.e-yantra.org/courses/theme_kd/learnings/control_system/maths_model/) · [Image Processing](https://portal.e-yantra.org/courses/theme_kd/learnings/image_processing/image_processing/) · [OpenCV Python](https://portal.e-yantra.org/courses/theme_kd/learnings/image_processing/opencv_py/) | M0–M7 |
| 🔒 KD Task pages: [Stage 1 intro](https://portal.e-yantra.org/courses/theme_kd/stage_1/introduction/) · [Task 0 overview](https://portal.e-yantra.org/courses/theme_kd/stage_1/task_0/overview/) · [Task 0 installation](https://portal.e-yantra.org/courses/theme_kd/stage_1/task_0/instruction/) (Task 1 pages: via the course menu) | setup, M1, M6, M7 |
| 🔒 PB learnings: [Linux](https://portal.e-yantra.org/courses/theme_pb/learnings/linux/linux/) · [MQTT](https://portal.e-yantra.org/courses/theme_pb/learnings/mqtt/mqtt/) · [MQTT Concepts](https://portal.e-yantra.org/courses/theme_pb/learnings/mqtt/mqtt_concepts/) · [MQTT Tutorials](https://portal.e-yantra.org/courses/theme_pb/learnings/mqtt/mqtt_tutorials/) · Path Planning (via the course menu) | P1–P3 |
| 🔒 [ROS 2 CLI cheat sheet PDF](https://portal.e-yantra.org/courses/theme_kd/learnings/ros/media/cli_cheats_sheet.pdf). **2019 edition:** in Humble `ros2 msg`/`ros2 srv` are gone (use `ros2 interface show`), and its bag examples are missing the word `bag` | M4 |
| 🔒 [*Fundamentals of Control Theory* book](https://portal.e-yantra.org/courses/theme_kd/learnings/control_system/pdf/fundamentals_of_control_r1_6.pdf). Focus: PID and LQR chapters | M3, L1 |
| 🔒 [`StateSpace.pdf`](https://portal.e-yantra.org/courses/theme_kd/learnings/control_system/pdf/StateSpace.pdf) (State-space representation of LTI systems) | L1 |
| 🔒 [`lqr.pdf`](https://portal.e-yantra.org/courses/theme_kd/learnings/control_system/pdf/lqr.pdf) (R. M. Murray, Lecture 2 – LQR Control) | L1 |
...
| Video | What it shows | Module |
|---|---|---|
| [Tuner and Plotter demo](https://youtu.be/ef2SI6uARuA) (2:21, silent) | KD 1B/1C PID tuner GUI walkthrough | M6, M7 |
| [task 1b submission demo](https://youtu.be/xqOyre-afOE) (0:59, silent) | Framing of the KD 1B video submission | M6 |
| [task 1c submission](https://youtu.be/Ut5wKqhMFdM) (0:42, silent) | Framing of the KD 1C video submission | M7 |
| [PacBot Task 1A expected output](https://youtu.be/95Kb59pPsXU) | What a successful PB 1A run looks like | P2 |
| [PacBot Task 1B expected output](https://youtu.be/Ac7dU4j0nVs) | What a successful PB 1B run looks like | P3 |

## 3. ROS 2

**Start here:** ⭐ [What Is ROS2? – Framework Overview](https://youtu.be/7TVWlADXwRw) (8:22) ·
⭐ [Getting Ready for ROS Part 4: ROS Overview](https://articulatedrobotics.xyz/ready-for-ros-4-ros-overview/) · the portal's **Turtlesim Resources** page (commands you type yourself). Module **M4**.
...
**Start here (M5):** ⭐ [Overview](https://mujoco.readthedocs.io/en/stable/overview.html) (model vs data, "hello world") ·
...
⭐ [LQR control](https://colab.research.google.com/github/google-deepmind/mujoco/blob/main/python/LQR.ipynb) (L1, after PID works) ·
...
| Resource | Notes | Module |
|---|---|---|
| ⭐ [Drone flight physics in under 2 minutes](https://www.youtube.com/watch?v=iQAPkN7OWus) (Dronology, 1:38) | Throttle, yaw, pitch, roll with the sticks | M2 |
| ⭐ [Introduction to Quadcopters](https://www.youtube.com/watch?v=Gp80qN7kvfs) (e-Yantra tech talk, 1:01:50) | **Watch ~12–26 min** (dynamics) and **~42–48 min** (control cascade = your Task 1B/1C setup). The rest is optional (parts list, planning, Q&A) | M2 |
| 🔒 Portal pages: Quadcopters · Swift Pico model · Quadcopter Control | Forces/torques figure (Coursera *Robotics: Aerial Robotics*), sensors, arming commands, hardware architecture | M2, M5, M0 |
...
| Resource | Length | Module |
|---|---|---|
| ⭐ [Everything You Need to Know About Control Theory](https://youtu.be/lBC1nEq0_nk) (MATLAB) | 16:07 | M3 (big picture) |
...
| ⭐ [PID Control — A brief introduction](https://www.youtube.com/watch?v=UR0hOmjaHp0) (Brian Douglas) | 7:44 | M3 ① |
| ⭐ [Simple Examples of PID Control](https://www.youtube.com/watch?v=XfAt6hNV8XM) | 13:10 | M3 ② |
| ⭐ [What Is PID Control? — Part 1](https://www.youtube.com/watch?v=wkfEZmsQqiA) (MATLAB) | ~11 min | M3 ② |
| [Anti-windup — Part 2](https://www.youtube.com/watch?v=NVLXCwc8HzM) | ~10 min | M3 ③ |
| [Noise filtering — Part 3](https://www.youtube.com/watch?v=7dUVdrs1e18) | ~10 min | M3 ③ |
| ⭐ [A PID Tuning Guide — Part 4](https://www.youtube.com/watch?v=sFOEsA0Irjs) | 12:05 | M3 ③ (**watch before tuning**) |
| [3 Ways to Build a Model — Part 5](https://www.youtube.com/watch?v=qhIjIu-Zk10) | 13:45 | L1 |
| [Manual and Automatic Tuning — Part 6](https://www.youtube.com/watch?v=qj8vTO1eIHo) | 13:31 | M3 ⑤ |
| [Important PID Concepts — Part 7](https://www.youtube.com/watch?v=tbgV6caAVcs) | 12:29 | M3 ⑤ |
| [Introduction to State-Space Equations](https://www.youtube.com/watch?v=hpeKrMG-WP0) (MATLAB) | 14:12 | L1 |
| [Introduction to System Stability and Control](https://www.youtube.com/watch?v=uqjKG32AkC4) | 11:32 | L1 |
| [Stability of Closed Loop Control Systems](https://www.youtube.com/watch?v=yf09OrHa520) | 11:36 | L1 |
| [What Is LQR Optimal Control?](https://www.youtube.com/watch?v=E_RDCFOlJx4) (MATLAB) | 17:24 | L1 |
| [Why the Riccati Equation Is Important for LQR](https://www.youtube.com/watch?v=ZktL3YjTbB4) (MATLAB) | 14:30 | L1 |
| [Jacobian (Wolfram MathWorld)](http://mathworld.wolfram.com/Jacobian.html) | reading | L1 |
...
**Known portal mistakes:** the PID page's I-term `Iterm = (Iterm + error)·Ki` should be `Iterm = Iterm + Ki·error` (roadmap M3-d);
the Quadcopter Control "To Do" leaves out thrust (M7-a); one eigenvalue is printed −2.824 instead of −2.828.

## 7. Image processing & OpenCV

**Start here (M1):** 🔒 portal *Image Processing Basics* (BGR vs RGB, HSV, **OpenCV hue is 0–179**) ·
...
**ROS 2 + OpenCV (Task 2 prep, T2):** [OpenCV in a ROS 2 C++ node (The Construct)](https://www.theconstruct.ai/how-to-integrate-opencv-with-a-ros2-c-node/) ·
...
**Start here (P1):** 🔒 portal *MQTT* → *MQTT Concepts* → *MQTT Tutorials* ·
...
on the same map. No external links; it's the main reading for **P2**. Pair it with the Computerphile videos in §10.

## 10. Extras added by the roadmap

Not on the portal. Chosen to make the "video ladders" (short → longer → deeper) work.

| Resource | Why | Module |
|---|---|---|
| [eYRC 2026-27 Official Launch](https://www.youtube.com/watch?v=G8m9-6jlzaE) | Big picture | M0 |
| [Digital Images — Computerphile](https://www.youtube.com/watch?v=06OHflWNCOE) | "An image is numbers" before OpenCV | M1 ① |
| [Warp Perspective / Bird View](https://www.youtube.com/watch?v=Tm_7fGolVGE) | Short perspective-transform demo | M1 ④ |
| [Computing Homography (Shree Nayar)](https://www.youtube.com/watch?v=l_qjO4cM74o) | The maths behind it | M1 ⑤ |
| ⭐ [Detecting ArUco markers with OpenCV and Python](https://pyimagesearch.com/2020/12/21/detecting-aruco-markers-with-opencv-and-python/) | Uses the **old ArUco API that matches OpenCV 4.5.4** | M1 ⑥ |
| [Drone Simulation and Control playlist (MATLAB)](https://www.youtube.com/playlist?list=PLn8PRpmsu08oOLBVYYIwwN_nvuyUqEjrj) | Optional drone-control series | M2 ④ |
| [Understanding PID Control playlist (MATLAB)](https://www.youtube.com/playlist?list=PLn8PRpmsu08pQBgjxYFXSsODEF3Jqmm-y) | The Part 1–7 series above as one playlist | M3 |
| [Dijkstra's Algorithm — Computerphile](https://www.youtube.com/watch?v=GazC3A4OQTE) → [A* Search — Computerphile](https://www.youtube.com/watch?v=ySN5Wnu88nE) | The second builds on the first | P2 |
